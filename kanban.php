                ...
                <div class="container-xl">
                    ...
                    <div class="kanban-row">
                        <div class="kanban-column" data-status="todo">
                            <div class="card">
                                <div class="card-header text-center bg-primary text-white bg-danger">TO-DO</div>
                                <div class="card-body">
                                    <div class="card mb-2 shadow" id="lead-123" draggable="true" draggable="true">
                                        <div class="card-body">
                                            <h5 class="card-title d-flex justify-content-between align-items-center">
                                                <b class="font-size-14">Test Usrt (#Lead-1234567)</b>
                                                <div class="dropdown">
                                                    ...
                                                    <ul class="dropdown-menu dropdown-menu-end"
                                                        ...
                                                        <li><a class="dropdown-item" href="#"><i class="fas fa-phone"
                                                                    aria-hidden="true"></i> Call Now</a></li>
                                                        <li><a class="dropdown-item" href="#"><i class="fas fa-sms"></i>
                                                                Send
                                                                SMS</a>
                                                        </li>
                                                        ...
                                                        <li><a class="dropdown-item" href="#"><i class="fas fa-trash"
                                                                    aria-hidden="true"></i> Delete</a></li>
                                                    </ul>
                                                </div>
                                            </h5>
                                            <div class="card-text">
                                                <p class="card-text font-size-12">Details about Task 1.</p>
                                                <div class="row">
                                                    <div class="col font-size-12">
                                                        <i class="fa fa-phone" aria-hidden="true"></i> &nbsp;
                                                        9876543210&nbsp;|&nbsp;
                                                        <span class="text text-danger" title="Created Date"> <i
                                                                class="fa fa-calendar-check"></i>&nbsp;20-1-2025
                                                            16:42</span>
                                                    </div>
                                                </div>
                                                <div class="row mt-1">
                                                    <div class="col font-size-12 d-flex justify-content">
                                                        <p class="p-1"><span class="badge bg-dark"
                                                                title="Lead For">BBPS</span></p>
                                                        <p class="p-1"><span class="badge bg-success"
                                                                title="Lead Source">Facebook</span></p>
                                                        <p class="p-1">
                                                            <span class="badge rounded-pill bg-success"
                                                                title="sunil chavan">SC</span>
                                                            <span class="badge rounded-pill bg-success">
                                        ...
                                        <div class="card-footer d-flex justify-content-between">
                                            <small class="text-muted ml-2" title="Last Modified"><i
                                                    class="fa fa-history" aria-hidden="true"></i> <em><b
                                                        class="font-size-10">20-1-2025
                                                        16:42</b></em></small>
                        ...
                        <div class="kanban-column">
                            <div class="card">
                                <div class="card-header bg-info" id="in-progress" ondrop="onDrop(event, 'in-progress')"
                                    ondragover="onDragOver(event)">In-Progress</div>
                                <div class="card-body">
                                    <div class="card mb-2" draggable="true">
                                        <div class="card-body">
                                            <h5 class="card-title d-flex justify-content-between align-items-center">
                                                <b class="font-size-14">Lead</b>
                                                <div class="dropdown">
                                                    <button class="btn btn-light btn-sm" type="button"
                                                        id="dropdownMenuButton1" data-bs-toggle="dropdown"
                                                        aria-expanded="false" title="Action">
                                                    ...
                                                    <ul class="dropdown-menu dropdown-menu-end"
                                                        aria-labelledby="dropdownMenuButton1">
                                                        <li><a class="dropdown-item" href="#"><i class="fa fa-phone"
                                                                    aria-hidden="true"></i> Call Now</a></li>
                                                        <li><a class="dropdown-item" href="#"><i class="fas fa-sms"></i>
                                                                Send
                                                                SMS</a>
                                                        </li>
                                                        <li><a class="dropdown-item" href="#"><i class="fa fa-calendar"
                                                                    aria-hidden="true"></i> Meeting</a></li>
                                                        <li><a class="dropdown-item" href="#"><i
                                                                    class="fas fa-edit"></i>
                                                                Edit</a>
                                                        </li>
                                            ...
                                            <div class="card-text justify-content-between">
                                                <p class="card-text font-size-12">Details about Task 1.</p>
                                                <p class="m-0 p-0 font-size-12">Name : Test Usrt </p>
                                                <p class="m-0 p-0 font-size-12">mobile Number :
                                                    <strong>9876543210</strong>
                                                </p>
                                                <p class="m-0 p-0 font-size-12">Lead Source : <span
                                                        class="badge bg-success">BBPS</span></p>
                                            </div>

                                            <div class="d-flex justify-content-between align-items-center">
                                                <span class="font-size-12">Leads Owner : <strong>Sunil</strong> <i
                                                        data-toggle="tooltip" data-placement="top"
                                                        title="Assigned to Leads" class="fa fa-user-plus"
                        ...
                        <div class="kanban-column">
                            <div class="card">
                                <div class="card-header bg-dark">Hold</div>
                                <div class="card-body">
...
<script>
    ...
    function onDragStart(event) {
        draggedCard = event.target; // Save the card being dragged
        event.dataTransfer.setData("text", event.target.dataset.leadId);
    }
    ...
    document.addEventListener("DOMContentLoaded", () => {
        ...
        columns.forEach(column => {
            ...
            column.addEventListener('drop', (e) => {
                ...
                if (droppedCard) {
                    column.appendChild(droppedCard);

                    // Call API to update lead status
                    const leadId = droppedCard.id.split('-')[1]; // Extract ID
    ...
    document.addEventListener('click', (e) => {
        if (e.target.classList.contains('btn-action')) {
            const action = e.target.classList[1].split('-')[1];
